...
export default function AppointmentsPage() {
  ...
  console.log(`[AppointmentsPage] role param: ${role}`);
  ...
  const handleStatusChange = (id: string, newStatus: Status) => {
    console.log(`[AppointmentsPage] Updating status for ${id} to ${newStatus}`);
    console.log(`[AppointmentsPage] handleStatusChange called. id: ${id}, newStatus: ${newStatus}`);
                    ...
                    {canEditStatus ? (
                      <div className="relative group/status">
                        <select
                          ...
                          className={`appearance-none pl-3 pr-8 py-1 rounded-full text-xs font-bold border cursor-pointer outline-none transition-all ${getStatusColor(apt.status)}`}
                        >
